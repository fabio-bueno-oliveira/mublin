...
export default function NewPost() {
  ...
  // Vídeo: apenas link do YouTube (upload nativo de vídeo agora é exclusivo do Scenes)
  const [videoMode, setVideoMode] = useState('none') // 'none' | 'youtube'
  ...
  return (
    <Container size="sm" py="md">
      <Stack gap="sm">
        ...
        {/* Vídeo (apenas link do YouTube; upload de vídeo agora é feito via Scenes) */}
        <Box>
