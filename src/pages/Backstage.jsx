...
const MOCK_DASHBOARD = {
  1: {
      ...
      past: [
        {
          name: 'Noite Indie',
          date: '05 Mar 2026',
          venue: 'Canto do Frango',
          city: 'São Paulo',
        },
        {
          name: 'Open Bar Sessions',
          date: '18 Fev 2026',
          venue: 'Bar Opinião',
          city: 'Porto Alegre',
        },
    ...
    rehearsals: [
      ...
      },
      {
        ...
        time: '14h00',
        location: 'Estúdio Zona Sul',
        type: 'Passagem de som',
      },
      {
        date: '11 Abr 2026',
        time: '20h00',
        location: 'Estúdio Zona Sul',
        type: 'Ensaio pré-show',
      },
    ],
    setlists: [
    ...
    finance: {
      ...
      recent: [
        {
          description: 'Cachê – Noite Indie',
          type: 'income',
          value: 1500.0,
          date: '05 Mar',
        },
        {
          description: 'Aluguel estúdio – Mar',
          type: 'expense',
          value: -800.0,
          date: '01 Mar',
        },
        {
          description: 'Cachê – Open Bar Sessions',
          type: 'income',
          value: 2000.0,
          date: '18 Fev',
        },
        {
          description: 'Equipamento de PA',
          type: 'expense',
          value: -450.0,
          date: '14 Fev',
        },
  ...
  2: {
    ...
    finance: {
      ...
      recent: [
        {
          description: 'Cachê – Festa do Peão',
          type: 'income',
          value: 5000.0,
          date: '15 Jan',
        },
    ...
    rehearsals: [
      {
        date: '02 Abr 2026',
        time: '20h00',
        location: 'Casa da Patrícia',
        type: 'Ensaio',
      },
    ],
    setlists: [
      { name: 'Set Parque', songs: 10, show: 'Jazz no Parque', status: 'draft' },
    ],
    finance: {
      balance: 0,
      income: 0,
      ...
      <Stack gap="xs">
        {shows.upcoming.map((s) => (
          <Paper
            ...
            p="xs"
            radius="sm"
            style={{ borderLeft: '3px solid var(--mantine-color-pink-5)' }}
          >
        ...
        {shows.past.length > 0 && (
          <>
            ...
            {shows.past.map((s) => (
              <Paper key={s.name} withBorder p="xs" radius="sm">
                <Group justify="space-between" wrap="nowrap">
                  <Box>
...
function FinanceCard({ finance }) {
  const balancePct =
    finance.income > 0 ? Math.round((finance.balance / finance.income) * 100) : 0
        ...
        >
          <Group gap="xs">
            ...
            <Text size="xs" c="yellow.7">
              R${' '}
              {finance.pending_income.toLocaleString('pt-BR', {
      ...
      {!dashboard && (
        <Paper withBorder radius="lg" p="xl" ta="center">
          ...
          <Text size="sm" c="dimmed" maw={400} mx="auto">
            Escolha um dos seus projetos ativos no seletor acima para visualizar o
            dashboard completo do Backstage.
          </Text>
        </Paper>
      )}
        ...
        <Stack gap="lg">
          ...
          <Paper withBorder radius="md" p="md">
            <Group gap="md" wrap="nowrap">
              <Avatar
                ...
                color="blue"
                src={
                  project?.picture ? PICTURE_AVATAR_PATH + project?.picture : undefined
                }
              >
          ...
          <SimpleGrid cols={{ base: 2, sm: 2, md: 4 }} spacing="md">
            <StatCard
              ...
              label="Integrantes"
              value={
                dashboard.members.confirmed.length + dashboard.members.pending.length
              }
            ...
            <StatCard
              ...
              value={
                dashboard.shows.upcoming.filter((s) => s.status === 'confirmed').length
              }
            ...
            <StatCard
              ...
              sub={
                dashboard.finance.pending_income > 0
                  ? `R$ ${dashboard.finance.pending_income.toLocaleString('pt-BR', { minimumFractionDigits: 2 })} a receber`
                  : undefined
              }
              color="green"
              trend={
                dashboard.finance.income > 0
                  ? Math.round(
                      (dashboard.finance.balance / dashboard.finance.income) * 100,
                    )
                  : undefined
              }
            />
