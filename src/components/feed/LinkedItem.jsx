...
import { Stack, Card, Avatar, Text, Group, Image, Badge } from '@mantine/core'

const PATH_PRODUCT_IMAGE =
  'https://ik.imagekit.io/mublin/products/tr:w-64,h-64,cm-pad_resize,bg-FFFFFF/'

export default function LinkedItem({ post }) {
  if (post.linked_gig_id) {
    return (
      <Card
        component={Link}
        to={`/gig/${post.slug}`}
    ...
    return (
      ...
      >
        <Group gap="xs">
          ...
          <Stack gap={0}>
            <Text size="xs" c="dimmed" fw={500}>
              {post.linked_product_brand_name}
            </Text>
